...
RUN cat /etc/os-release \
    ...
    https://kojipkgs.fedoraproject.org//packages/kernel/6.5.9/300.fc39/x86_64/kernel-6.5.9-300.fc39.x86_64.rpm \
    https://kojipkgs.fedoraproject.org//packages/kernel/6.5.9/300.fc39/x86_64/kernel-core-6.5.9-300.fc39.x86_64.rpm \
    https://kojipkgs.fedoraproject.org//packages/kernel/6.5.9/300.fc39/x86_64/kernel-modules-6.5.9-300.fc39.x86_64.rpm \
    https://kojipkgs.fedoraproject.org//packages/kernel/6.5.9/300.fc39/x86_64/kernel-modules-core-6.5.9-300.fc39.x86_64.rpm \
