...
RUN cat /etc/os-release \
  ...
  && rpm-ostree override replace https://kojipkgs.fedoraproject.org//packages/kernel/6.1.11/200.fc37/x86_64/kernel-6.1.11-200.fc37.x86_64.rpm \
  https://kojipkgs.fedoraproject.org//packages/kernel/6.1.11/200.fc37/x86_64/kernel-core-6.1.11-200.fc37.x86_64.rpm \
  https://kojipkgs.fedoraproject.org//packages/kernel/6.1.11/200.fc37/x86_64/kernel-modules-6.1.11-200.fc37.x86_64.rpm \
